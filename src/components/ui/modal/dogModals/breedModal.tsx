...
interface BreedModalProps {
    ...
    breedName: string;
    sires: any[]; // Replace 'any' with your dog type
    dams: any[];  // Replace 'any' with your dog type
}

export const BreedModal: React.FC<BreedModalProps> = ({
    isOpen,
    className,
    onClose,
    ...
    const filteredData = (activeTab === 'sire' ? sires : dams)
        .filter(dog =>
            Object.entries(filters).every(([key, value]) => {
                ...
                const dogValue = String(dog[key as keyof typeof dog]).toLowerCase();
                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-6">
                            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">{breedName}</h4>
                        </div>
