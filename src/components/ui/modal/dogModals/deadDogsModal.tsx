...
export const DeadDogsListModal: React.FC<ModalProps> = ({
    isOpen,
    className,
    onClose,
    ...
    const filteredData = (activeTab === 'sire' ? sires : dams)
        .filter(dog =>
            Object.entries(filters).every(([key, value]) => {
                ...
                const dogValue = String(dog[key as keyof DeadDog]).toLowerCase();
                        ...
                        <div className="max-w-full overflow-x-auto  text-gray-800 dark:text-white/90">
                            <Table>
                                <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                                    <TableRow>
                                        {["S.No", "DOG NAME", "ACC NO", "DEATH DATE", "REASON", "STATUS"].map((header, idx) => (
                                ...
                                <TableBody>
                                    {paginatedData.map((order, index) => (
                                        ...
                                        >
                                            ...
                                            <TableCell className="px-5 py-4 text-start">{order.deathDate || ""}</TableCell>
                                            <TableCell className="px-5 py-4 text-start">{order.deathReason || ""}</TableCell>
