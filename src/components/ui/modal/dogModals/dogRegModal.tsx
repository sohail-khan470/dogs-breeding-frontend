...
// export const DogRegModal: React.FC<ModalProps> = ({
//   isOpen,
//   className,
//   onClose,
...
//       <div
//         ref={modalRef}
//         className={`${contentClasses}  ${className} max-h-[80vh] overflow-y-auto`}
...
//               Register new Dog info here.
//             </p>
//           </div>
//             <div className="grid grid-cols-2 gap-6 xl:grid-cols-2 overflow-y-auto custom-scrollbar flex">
