...
import { useGermanShepherds } from "../../../dogsCategory/hooks/useGermanShepherd";
...
export const GermanSheperdListModal: React.FC<ModalProps> = ({
    isOpen,
    className,
    onClose,
    ...
    const { sires, dams } = useGermanShepherds();
                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-6">
                            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">German Shepherd</h4>
                        </div>
