...
import { useLabradorRetriever } from "../../../dogsCategory/hooks/useLabradorRetriever";
import { LabradorRetriever } from "../../../dogsCategory/types/LabradorRetriever";
...
export const LabradorRetrieverListModal: React.FC<ModalProps> = ({
    isOpen,
    className,
    onClose,
                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-6">
                            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">Labrador Retriever</h4>
                        </div>
