...
import { LitterRegistration } from "../../../dogsCategory/types/littersRegistration";
...
interface ModalProps {
    ...
    dog: LitterRegistration | null
}


export const RegistrationViewModal: React.FC<ModalProps> = ({
    isOpen,
    className,
    onClose,
                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-6">
                            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">Litter Registration Detail</h4>
                        </div>
                        ...
                        <div className="max-w-full overflow-x-auto text-gray-800 dark:text-white/90">
                                ...
                                <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 mb-8">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-gray-800 dark:text-white">{dog?.litter?.breed?.breed || "N/A"}</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                            ...
                            <div className="mt-6">
                                ...
                                {dog?.name && (
                                    <div className="flex items-center gap-2">
                                        <span className="text-gray-500 dark:text-gray-400">Puppy Name:</span>
                                        <span className="text-gray-800 dark:text-white">{dog?.name || "N/A"}</span>
                                    </div>
                                )}
                                {/* No of puppies */}
                                {dog?.color && (
                                    <div className="flex items-center gap-2 mt-4">
                                        <span className="text-gray-500 dark:text-gray-400">Puppy Color:</span>
                                ...
                                {/* No of female */}
                                <div className="flex items-center gap-2 mt-4">
                                    <span className="text-gray-500 dark:text-gray-400">Puppy Microchip:</span>
                                    <span className="text-gray-800 dark:text-white">{dog?.microchip || "N/A"}</span>
                                </div>
                                {/* No of Puppies */}
                                {dog?.location && (
                                    <div className="flex items-center gap-2 mt-4">
                                        <span className="text-gray-500 dark:text-gray-400">Puppy Location:</span>
