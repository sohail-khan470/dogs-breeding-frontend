...
import { useSoldDog } from "../../../dogsCategory/hooks/useSoldDog";
import Badge from "../../badge/Badge";
import { SoldDog } from "../../../dogsCategory/types/soldDog";
...
export const SoldDogsListModal: React.FC<ModalProps> = ({
    isOpen,
    className,
    onClose,
    ...
    const { sires, dams } = useSoldDog();
    console.log("sold sire", sires)
    ...
    const filteredData = (activeTab === 'sire' ? sires : dams)
        .filter(dog =>
            Object.entries(filters).every(([key, value]) => {
                ...
                const dogValue = String(dog[key as keyof SoldDog]).toLowerCase();
                ...
                >
                    ...
                    <div className="p-4">
                        <div className="flex justify-between items-center mb-6">
                            <h4 className="text-2xl font-semibold text-gray-800 dark:text-white/90">Sold Dogs</h4>
                        </div>
